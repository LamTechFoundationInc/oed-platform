    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-promoted-posts').once('mtowlCarouselPromotedPostsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.openelections.owlCarouselPromotedPostsInit.owlPromotedPostsAutoPlay,
          autoplayTimeout: drupalSettings.openelections.owlCarouselPromotedPostsInit.owlPromotedPostsEffectTime,
          nav: true,
          dots: false,
          loop: true,
