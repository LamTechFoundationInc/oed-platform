    ...
    attach: function (context, settings) {
      ...
      function initialize() {
        $(context).find(mapSelector).once('mtGoogleMapsInit').each(function(index, item) {
          var map_locations_string = $(this).attr('data-attribute-op-locations');
          var locations = JSON.parse(map_locations_string);
          var zoom = parseInt($(this).attr('data-attribute-op-map-zoom'));
          ...
          $(".field--op-collapsible-block .google-map-canvas", context).closest('.collapse').on('shown.bs.collapse', function() {
